...
try:
    ...
    print(f"[rerun] disabled (no display): {e}")
...
while True:
    ...
    base_action = robot._from_keyboard_to_base_action(keyboard_keys) if not NO_ROBOT else {}
    lift_action = robot._from_keyboard_to_lift_action(keyboard_keys) if not NO_ROBOT else {}
